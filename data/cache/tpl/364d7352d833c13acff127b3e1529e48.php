<?php exit;?>0015761371284b86a8f804b38514a0958f8edd6e2e0fs:2553:"a:2:{s:8:"template";s:2489:"<footer class="pt-40 pb-10">
    <div class="container">
        ...
        <ul class="mt-30 mb-20 cl">
            ...
            <li class="col-sm-3 col-xs-3">
                <a href="/list-gongluezixun.html" class="text-c c-white f-14">活动攻略</a>
            </li>
        </ul>

        <hr>

        <p class="text-c c-white f-14 mt-10">Copyright &copy; 2007-2018 爱聚派有限公司 版权所有 并保留所有权力</p>
    </div>
</footer>
...
<section class="bottom-intro">
    ...
    <p class="text-c">您还可以通过邮件【15216808758@163.com】<br/>或者关注微信公众号【ijuparty(爱聚派轰趴馆)】进行咨询。</p>

</section>

<div class="bottom-nav pt-5 pb-5">
    <ul class="cl">
        <li class="col-xs-3">
            <a href="/">
                <img src="/public/assets/images/41.png" class="am-img-responsive">
        ...
        <li class="col-xs-3">
            <a href="/list-gongluezixun.html">
                <img src="/public/assets/images/43.png" class="am-img-responsive">
                <span class="am-navbar-label">攻略咨询</span>
            </a>
        </li>
        <li class="col-xs-3">
